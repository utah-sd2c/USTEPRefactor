...
/// A collection of feature flags for the USTEP.
enum FeatureFlags {
    ...
    /// Defines if the application should connect to the local firebase emulator. This used to always set to true when using the iOS simulator.
